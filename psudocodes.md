...
```
### Double Ended Queue[]: # Path: psudocodes.md
```
PROGRAM DEQUE
DEFINE SIZE 10
...
```
### Infix to Postfix[]: # Path: psudocodes.md
```
...
```
### Postfix Evaluation[]: # Path: psudocodes.md
```
...
### Linked List[]: # Path: psudocodes.md
```
PROGRAM LINKED_LIST
...
### Queue using Linked List[]: # Path: psudocodes.md
```
...
### Stack using Linked List[]: # Path: psudocodes.md
```
...
```
### Circular Linked List[]: # Path: psudocodes.md
```
